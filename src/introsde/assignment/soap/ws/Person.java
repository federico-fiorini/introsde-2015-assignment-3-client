 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="measure" type="{http://ws.soap.assignment.introsde/}healthProfile" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class Person {
    ...
    public static class HealthProfile {
        ...
        protected List<introsde.assignment.soap.ws.HealthProfile> measure;
         ...
         * {@link introsde.assignment.soap.ws.HealthProfile }
         * 
         * 
         */
        public List<introsde.assignment.soap.ws.HealthProfile> getMeasure() {
            if (measure == null) {
                measure = new ArrayList<introsde.assignment.soap.ws.HealthProfile>();
            }
            return this.measure;
        }
