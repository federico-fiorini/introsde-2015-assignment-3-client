 ...
 *       &lt;sequence>
 *         &lt;element name="history" type="{http://ws.soap.assignment.introsde/}healthProfileHistory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadPersonHistoryResponse {
    ...
    protected List<HealthProfileHistory> history;
    ...
    public List<HealthProfileHistory> getHistory() {
        if (history == null) {
            history = new ArrayList<HealthProfileHistory>();
        }
        return this.history;
    }
